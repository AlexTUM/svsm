...
use crate::protocols::check::check_kernel_protocol_request;
...
use crate::protocols::{RequestParams, SVSM_CHECK_KERNEL, SVSM_CORE_PROTOCOL};
...
fn request_loop_once(
    ...
    match protocol {
        ...
        SVSM_CHECK_KERNEL => check_kernel_protocol_request(request, params).map(|_| true),
